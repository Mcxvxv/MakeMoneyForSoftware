...
public class CompleteUserInfoActivity extends AppCompatActivity {
    ...
    private DatePickerDialog.OnDateSetListener myDatelistener=new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            CompleteUserInfoActivity.this.year=year;
            CompleteUserInfoActivity.this.month=month;
            CompleteUserInfoActivity.this.day=dayOfMonth;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    location.setText(jsonObject.getString("loaction"));
...
//                    currentUser.setOpendate(birthday.getText().toString());
    ...
    public void uploaduserData() {
        ...
        final String teletext = tele.getText().toString();
        Log.d("msg", nametext + "+" + sextext + "+" + mailtext + "+" + locationtext + "+" + teletext);
        RequestQueue mQueue = Volley.newRequestQueue(getApplicationContext());
        String url = "http://119.23.13.19:8080/Aliyun/RegisterServlet";
        if (nametext.equals("") || sextext.equals("") || mailtext.equals("") || locationtext.equals("") || teletext.equals("")) {
...
//                    currentUser.setOpendate(birthday.getText().toString());
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    map.put("sex", sextext);
                    map.put("mail", mailtext);
                    map.put("location", locationtext);
                    map.put("type", "uppdateUserInfo");
                    map.put("tele", teletext);
                    return map;
                }
            };
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DATE_DIALOG_ID:
                DatePickerDialog datePickerDialog=new DatePickerDialog(CompleteUserInfoActivity.this, AlertDialog.THEME_HOLO_LIGHT, myDatelistener, year, month, day);
