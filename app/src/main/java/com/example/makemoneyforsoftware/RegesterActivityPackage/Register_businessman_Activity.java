...
public class Register_businessman_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register_businessman_);
        ...
        regester_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(psd.equals("")){
                    Toast.makeText(Register_businessman_Activity.this,"请输入密码",Toast.LENGTH_SHORT).show();
                }else if(!cfm_psd.equals(psd)){
                    Toast.makeText(Register_businessman_Activity.this,"请重新确认密码",Toast.LENGTH_SHORT).show();
                }else {
                    regidterBusinessman(tele_number,psd);
                    Intent intent=new Intent(Register_businessman_Activity.this, MainActivity.class);
    ...
    public void regidterBusinessman(final String tele, final String password){
        Businessman businessman=new Businessman();
        businessman.setTele(tele);
        businessman.setPsd(password);
        businessman.save(new SaveListener<String>() {
            @Override
            public void done(String s, BmobException e) {
                if(e==null){
                    Toast.makeText(Register_businessman_Activity.this,"注册成功",Toast.LENGTH_SHORT).show();
                }else {
