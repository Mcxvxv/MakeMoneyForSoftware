...
public class BusinessmanJiesuanFragment extends Fragment implements CardStackView.ItemExpendListener{
...
//                refreshlayout.finishRefresh(2000/*,false*/);//传入false表示刷新失败
        ...
        mTestStackAdapter = new MyAnotherStackAdapter(getActivity(),4);
